...
if(antwoord == "A"):
        print("dat is fout wat denk je wel niet")
elif(antwoord == "B"):
        print("dat is goed ik ben net 16")
elif(antwoord == "C"):
        print ("dat is fout wat denk je wel niet")

print("welke kant ga ik op in de opleiding")
...
if(antwoord == "A"):
        ...
        print("dat is fout ik ga niet de software kant op")
